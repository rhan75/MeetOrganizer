...
class GenerateAgeGroupEventResultLayout(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.controller.insert_text(self.status_text, 'Ready to generate age group result for event')
    ...
    def generate_report(self):
        reports.generate_age_group_report(self.controller.competition_id, self.controller.event, self.controller.directory, self.controller.engine)
